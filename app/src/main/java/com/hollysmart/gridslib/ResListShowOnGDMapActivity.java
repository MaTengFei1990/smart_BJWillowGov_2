...
//
//public class ResListShowOnGDMapActivity extends StyleAnimActivity implements View.OnClickListener, MainView ,BaiduMap.OnMapLoadedCallback{
//
//
...
//        mGaoDeMap.setOnMapLoadedCallback(this);
//        // 定位初始化
...
//
//        // 编辑取景
//        mGaoDeMap.setOnMapStatusChangeListener(this);
//    }
//
//
...
//                    mGaoDeMap.addOverlay(ooPolyline2);
//                }
//            }
//
//
...
//        resDatalist.clear();
//        mainPresenter.getAllSpotOfArea(taskid,context, resDatalist,roadBean.getId());
//
//        new GetNetTreeListAPI(userInfo,TreeFormModelId, roadBean, new GetNetTreeListAPI.DatadicListIF() {
//            @Override
