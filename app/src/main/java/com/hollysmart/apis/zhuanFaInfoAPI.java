...
public class zhuanFaInfoAPI implements INetModel {
    ...
    public zhuanFaInfoAPI(String RefArticleID,String id, String type_id, String content, String latitude, String longitude, String position, String ispublic, String state, String tagid, String imgs, SaveInfoIF saveInfoIFIF) {
    ...
    public void request() {
        ...
        if (!Utils.isEmpty(RefArticleID)) {
            postFormBuilder.addParams("RefArticleID", RefArticleID);
        }
