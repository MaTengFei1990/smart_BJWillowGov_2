...
//    public static String REFRESH_HEADER_LASTTIME = "'Last update' M-d HH:mm";
    ...
    private void initView(Context context, AttributeSet attrs) {
        ...
        mTitleText.setTextColor(getResources().getColor(R.color.black6));

        mLastUpdateText = new TextView(context);
        mLastUpdateText.setTextColor(getResources().getColor(R.color.black6));
        ...
        if (ta.hasValue(com.scwang.smartrefresh.layout.R.styleable.ClassicsHeader_srlDrawableArrow)) {
            ...
            mArrowDrawable.parserColors(getResources().getColor(R.color.black6));
        ...
        if (ta.hasValue(com.scwang.smartrefresh.layout.R.styleable.ClassicsHeader_srlDrawableProgress)) {
            ...
            mProgressDrawable.setColor(getResources().getColor(R.color.black6));
    ...
    public void setPrimaryColors(@ColorInt int ... colors) {
        if (colors.length > 0) {
            ...
            if (colors.length > 1) {
                ...
                setAccentColor(colors[0] == getResources().getColor(R.color.black6) ? getResources().getColor(R.color.black6) : getResources().getColor(R.color.black6));
            }
        }
    }
...
//                replaceRefreshLayoutBackground(refreshLayout);
    ...
    public MyClassicsHeader setAccentColor(@ColorInt int accentColor) {
        ...
        mLastUpdateText.setTextColor(accentColor&getResources().getColor(R.color.black6)|getResources().getColor(R.color.black6));
        return this;
    }
