...
public class GetNetResListAPI implements INetModel {
    ...
    public GetNetResListAPI(UserInfo userInfo, ProjectBean projectBean, DatadicListIF datadicListIF) {
    ...
    public void request() {
        ...
        try {
            ...
            object.put("fd_resmodelid", projectBean.getfTaskmodel());
