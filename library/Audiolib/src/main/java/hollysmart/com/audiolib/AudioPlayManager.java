...
public class AudioPlayManager implements SensorEventListener {
     ...
     * @param playListener
     */
    public void startPlayNetData(Context context, String netUrl, IAudioPlayListener playListener) {
        if (context != null && netUrl != null) {
            this.context = context;
            if (this._playListener != null && this._playingUri != null) {
                this._playListener.onStop(this._playingUri);
            }
            ...
            try {
                ...
                this._mediaPlayer.setDataSource(netUrl);
                this._mediaPlayer.setAudioStreamType(3);
                this._mediaPlayer.prepare();
                this._mediaPlayer.start();
                if (this._playListener != null) {
                ...
                var5.printStackTrace();
                if (this._playListener != null) {
                    this._playListener.onStop(null);
                    this._playListener = null;
                }
