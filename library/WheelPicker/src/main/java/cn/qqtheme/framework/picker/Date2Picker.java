 ...
 * @version 2015 /12/14
 */
public class Date2Picker extends WheelPicker {
    /**
     * 年月日
     */
     ...
     * 年月日时分
     */
    public static final int YEAR_MONTH_DAY_HOUR_MIN = 4;
    /**
     * 年月日时
     */
    public static final int YEAR_MONTH_DAY_HOUR = 5;
     ...
     */
    public Date2Picker(Activity activity) {
     ...
     */
    public Date2Picker(Activity activity, @Mode int mode) {
        super(activity);
        this.mode = mode;
    ...
    public void setSelectedItemData(int year, int month, int day,String hour,String min) {
        selectedYearIndex = findItemIndex(years, year);
        selectedMonthIndex = findItemIndex(months, month);
        selectedDayIndex = findItemIndex(days, day);
        selectedHour = hour;
    ...
    public void setSelectedItem(int year, int month, int day, String hour) {
        selectedYearIndex = findItemIndex(years, year);
        selectedMonthIndex = findItemIndex(months, month);
        selectedDayIndex = findItemIndex(days, day);
        selectedHour = hour;
    ...
    protected View makeCenterView() {
        ...
        if (mode == YEAR_MONTH_DAY_HOUR_MIN) {
        ...
        if (onDatePickListener != null) {
            ...
            switch (mode) {
                ...
                case YEAR_MONTH_DAY_HOUR_MIN:
                    ((OnYearMonthDayHourMinPickListener) onDatePickListener).onDatePicked(year,month, day,hour,min);
                    break;
                case YEAR_MONTH_DAY_HOUR:
                    ((OnYearMonthDayHourPickListener) onDatePickListener).onDatePicked(year,month, day,hour);
                    break;
                default:
    ...
    public interface OnYearMonthDayHourMinPickListener extends OnDatePickListener {
         ...
         * @param min   the min
         */
        void onDatePicked(String year, String month, String day,String hour,String min);
